prompt --application/shared_components/user_interface/lovs/students_student_name
begin
--   Manifest
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(28129273904294613672)
,p_lov_name=>'STUDENTS.STUDENT_NAME'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
